...
def xgboost_wrapper(data_dir, random_state: Optional[int] = 42, dropna: Literal[True, False] = False):
    '''
    ...
    submit.to_csv("C:/Users/lenovo/Desktop/HKUSTGZ-PG/Course-project/DSAA-5002/Final-Project/Data/Q5/Q5_output.csv", \
                  index=False)
